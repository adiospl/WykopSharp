...
namespace WykopSharpClient.Repository.Interface
{
    public interface IProfileRepository
    {
        ...
        Task<BooleanModel> Block(string profileName);
        ...
        Task<BooleanModel> Observe(string profileName);
        Task<List<Link>> Published(string profileName, int page = 1);
        Task<List<RelatedLink>> Related(string profileName, int page = 1);
        Task<BooleanModel> Unblock(string profileName);
        Task<BooleanModel> Unobserve(string profileName);
    }
}